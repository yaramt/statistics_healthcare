...
# Plot on phone data
plot(sitting_phone$timestamp,sitting_phone$acceleration,type = "l",col = 2,xlab = "Timestamp",ylab = "Acceleration sitting on phone")
plot(walking_phone$timestamp,walking_phone$acceleration,type = "l",col = 4,xlab = "Timestamp",ylab = "Acceleration walking on phone")

# Plot off phone data
plot(sitting_no_phone$timestamp,sitting_no_phone$acceleration,type = "l",col = 2,xlab = "Timestamp",ylab = "Acceleration walking not on phone")
plot(walking_no_phone$timestamp,walking_no_phone$acceleration,type = "l",col = 4,xlab = "Timestamp",ylab = "Acceleration sitting not on phone")
