...
for (index in c(1:15)){
  ...
  dat <- read.csv(sprintf("/Users/yara/Desktop/final_report_statistics/github_statistics_healthcare-main/Data_clean/log_p%s.txt", index), sep="|")
...
```
## Normal Distribution Check for 15 Participants
```{r}
